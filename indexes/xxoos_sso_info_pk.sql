...
-- Create Index
-- ------------------------------------------
prompt Creating Index xxoos_sso_info_pk
prompt
CREATE UNIQUE INDEX ^XX_SCH..xxoos_sso_info_pk
ON ^XX_SCH..xxoos_sso_info (ID);



-- End of script xxoos_sso_info_pk.sql
